                    ...
                    <form action="" method="">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control jgnputih" value="{{$srt->user->nama}}" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control jgnputih" value="{{$srt->tahun}}" readonly>
                                </div>
                            </div>
                            <div class="modal-footer">
                            <a href="/pegawai/ctthn" class="btn btn-primary">Ok</a>
                            </div>
                            </form>
                            </div>
                </div>
