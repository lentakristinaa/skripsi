                  ...
                  <div class="card-body">
                   ...
                   <?php } ?>
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="/pegawai/ctskt/simpan" method="POST">
                                @csrf
                        ...
                        @foreach ($srt as $s)
                            <tr>
                                ...
                                <?php if ($s->status == "disetujui") { ?>
                                    <a href="/pegawai/printskt/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                                <?php  } elseif ($s->status == "selesai") { ?>
                                  <a href="/pegawai/printskt/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                               <?php } else { ?>
                                    <a href="/pegawai/infoskt/{{$s->id}}" class="btn btn-info"><img src="" alt="Info" width="20" height="20"></a>
                                    <?php } ?>
                                </td>
                                <td> {{ $s->status }} </td>
                            </tr>
