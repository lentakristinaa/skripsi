...
<body>
    <center>
        ...
        <table  width="569">
            <tr>
                <td>
                    <font size="2"> <p align= "justify" style="text-indent: 45px;"> Dengan ini saya mengajukan permohonan cuti tahunan untuk tahun {{$tahun}} selama {{$durasi}}, mulai tanggal {{$tgl_mulai}}
                    sampai dengan tanggal {{$tgl_sls}}
        ...
        <table  border ='1' width="569">
            <tr>
                ...
                <td>
                <center>
                    <u>CATATAN PERTIMBANGAN ATASAN LANGSUNG</u><br><br><br>@php echo DNS2D::getBarcodeHTML('https://i.imgur.com/isfMAJp.png', 'QRCODE',5,5); @endphp<br><br><br><u>KEPUTUSAN PEJABAT YANG <br> BERWENANG MEMBERIKAN CUTI</u>
