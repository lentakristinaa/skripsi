...
<body>
    <center>
        ...
        <table  width="569">
            <tr>
                <td>
                    <font size="2"> <p align= "justify" style="text-indent: 45px;"> Dengan ini saya mengajukan permohonan cuti bersalin untuk persalinan yang ke {{$keterangan}} untuk
                    persalinan mulai tanggal {{$tgl_mulai}} sampai dengan 2(dua) bulan persalinan </font></p>
        ...
        <table  border ='1' width="569">
            <tr>
                ...
                <td>
                <center>
                    <u>CATATAN PERTIMBANGAN ATASAN LANGSUNG</u><br><br><br>@php echo DNS2D::getBarcodeHTML('https://i.imgur.com/9FB6vnV.png', 'QRCODE',5,5); @endphp<br><br><br>
                    <u>KEPUTUSAN PEJABAT YANG <br> BERWENANG MEMBERIKAN CUTI</u>
