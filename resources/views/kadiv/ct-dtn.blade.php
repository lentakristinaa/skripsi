...
<div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Cuti diluar Tanggungan Negara</h4>
                       <?php /* <!-- Button trigger modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="/kadiv/ctdtn/simpan" method="POST">
                                @csrf
                        ...
                        @foreach ($srt as $s)
                            <tr>
                                ...
                                <?php if ($s->status == "disetujui") { ?>
                                    <a href="/kadiv/printdtn/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                                <?php  }  elseif ($s->status == "selesai") { ?>
                                    <a href="/kadiv/printdtn/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                               <?php }else { ?>
                                    <a href="/kadiv/infodtn/{{$s->id}}" class="btn btn-info"><img src="" alt="Info" width="20" height="20"></a>
                                    <?php } ?>
                                </td>
                                <td>
                                <?php
                                    if ($s->status == "diteruskan") {
                                      ...
                                      echo "Telah Disetujui";
                                        ...
                                        <form action="{{ route('kadiv.updatedtn',$s->id) }}" method="POST">
                                            @csrf
                                            @method('put')
