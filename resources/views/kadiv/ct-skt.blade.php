                    ...
                    <h4 class="card-title">Cuti Sakit</h4>
                       <?php /* <!-- Button trigger modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="/kadiv/ctskt/simpan" method="POST">
                                @csrf
                        ...
                        @foreach ($srt as $s)
                            <tr>
                                ...
                                <?php if ($s->status == "disetujui") { ?>
                                    <a href="/kadiv/printskt/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                                <?php  }  elseif ($s->status == "selesai") { ?>
                                    <a href="/kadiv/printskt/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                               <?php }else { ?>
                                    <a href="/kadiv/infoskt/{{$s->id}}" class="btn btn-info"><img src="" alt="Info" width="20" height="20"></a>
                                    <?php } ?>
                                </td>
                                <td>
                                <?php
                                    if ($s->status == "diteruskan") {
                                        ...
                                        <form action="{{ route('kadiv.updateskt',$s->id) }}" method="POST">
                                            @csrf
                                            @method('put')
