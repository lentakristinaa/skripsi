                    ...
                    <h4 class="card-title">Cuti Tahunan</h4>
                       <?php /* <!-- Button trigger modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="/kadiv/ctthn/simpan" method="POST">
                                @csrf
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="">Cuti untuk Tahun</label>
                        ...
                        @foreach ($srt as $s)
                            <tr>
                                ...
                                <?php if ($s->status == "disetujui") { ?>
                                    <a href="/kadiv/printthn/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                                <?php  }  elseif ($s->status == "selesai") { ?>
                                    <a href="/kadiv/printthn/{{$s->id}}" class="btn btn-info"><img src="/img/logoprint.png" alt="Print" width="20" height="20"></a>
                               <?php }else { ?>
                                    <a href="/kadiv/infothn/{{$s->id}}" class="btn btn-info"><img src="" alt="Info" width="20" height="20"></a>
                                    <?php } ?>
                                </td>
                                <td>
                                <?php
                                    if ($s->status == "diteruskan") {
                                        ...
                                        <form action="{{ route('kadiv.updatethn',$s->id) }}" method="POST">
                                            @csrf
                                            @method('put')
